# matplotlib.finance candlesticks
...
def graphData(stock,MA1,MA2):
    ...
    #try:
    for a in [1]:
        newAr = web.get_data_yahoo("aapl", datetime(2016,1,1), datetime(2016,5,1))
        date = newAr.index.values
        closep, highp, lowp, openp, volume = newAr.Close, newAr.High, newAr.Low, newAr.Open, newAr.Volume 
